...
<div class="nav-section">
    ...
    {{-- Perizinan: document with checkmark --}}
    ...
    {{-- Penghuni Kamar: group of people --}}
...
<div class="nav-section">
    ...
    {{-- Komponen Nilai: bar chart (grades/scores) --}}
